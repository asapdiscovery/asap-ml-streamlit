...
st.selectbox("How would you like to upload your SMILES?", ["Upload a CSV file", "Draw a molecule", "Enter SMILES"])
...
if uploaded_file is not None:
    ...
    if model is None:
        ...
        # make this bold
        st.write(f"Predicting {_target_str} {endpoint_value} for {column} using model {model.name}")
